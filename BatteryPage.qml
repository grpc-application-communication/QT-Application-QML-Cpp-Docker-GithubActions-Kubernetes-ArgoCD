                ...
                Item {
                    ...
                    Canvas {
                        ...
                        onPaint: {
                            ...
                            var currentAngle = startAngle + (batterylevel / maxBatterylevel) * (2 * Math.PI - (startAngle - endAngle));
                        ...
                        Connections {
                            target: batterypage
                            onBatterylevelChanged: arcCanvas.requestPaint()
                        }
                    }
                    ...
                    Image {
                        source: "qrc:/assets/ic_battery.svg"
                        width: 32
                        height: 32
                        anchors.bottom: parent.bottom
