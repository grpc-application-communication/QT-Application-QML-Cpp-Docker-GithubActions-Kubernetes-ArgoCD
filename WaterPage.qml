...
Item {
    ...
    // Bind water directly to the C++ backend's property
    property real water: vehicleDataMonitor.temperature
    property real maxWater: 200
                ...
                Item {
                    ...
                    Canvas {
                        ...
                        onPaint: {
                            ...
                            var currentAngle = startAngle + (water / maxWater) * (2 * Math.PI - (startAngle - endAngle));
                        ...
                        Connections {
                            target: waterpage
                            onWaterlevelChanged: arcCanvas.requestPaint()
                        }
                    }
                    ...
                    Image {
                        source: "qrc:/assets/temperature.svg"
                        width: 32
                        height: 32
                        anchors.bottom: parent.bottom
